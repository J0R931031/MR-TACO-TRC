    ...
    <div class="container-two">
      <v-img :src="fondores" style="position: static; height: 100%;">
        <div id="orden-container">
          <!-- Botones para seleccionar platillos, bebidas y postres -->
          <div class="button-group">
            <v-btn @click="showPlatillosSection = true" class="platillos-button">Seleccionar Platillos</v-btn>
            <v-btn @click="showBebidasSection = true" class="bebidas-button">Seleccionar Bebidas</v-btn>
            <v-btn @click="showPostresSection = true" class="postres-button">Seleccionar Postres</v-btn>
            <v-btn @click="showHistorial = true" class="historial-button">Historial</v-btn>
          </div>
              ...
              <div class="platillo-list">
                <div v-for="(platillo, index) in platillos" :key="index" class="platillo-section">
                  <v-select
                    ...
                    :label="`Selecciona platillo ${index + 1}`"
                    :items="platilloOptions"
>>>>>>> efbe8361a2c79d93dd4805cd7a3f2a76f2bd367c
                    outlined
                  ></v-select>
                  <div v-if="platillo.selected" class="counter-section">
                    <p>Detalles para {{ platillo.selected }}:</p>
                  ...
                  <div v-if="platillo.selected" class="ingredients-section">
                    <v-btn
                      @click="viewIngredients(platillo, 'platillo')"
                      class="ingredients-button"
                      style="background-color: orange; color: white;"
                    >Ver Ingredientes</v-btn>
                  </div>
                  <div v-if="platillo.selected" class="notes-section">
                    <v-textarea v-model="platillo.notes" label="Escribe tus notas aquí" rows="4" outlined></v-textarea>
                  </div>
                </div>
              </div>
<<<<<<< HEAD
...
=======
              <div class="button-container">
                <v-btn @click="addPlatillo" class="action-button platillos-add-button">Añadir otro platillo</v-btn>
                <div class="button-space">
                  <v-btn @click="savePlatillos" class="action-button platillos-save-button">Guardar</v-btn>
                  <v-btn @click="cancelPlatillos" class="action-button platillos-cancel-button">Cancelar</v-btn>
                  <button @click="showPlatillosSection = false" class="action-button">CERRAR</button>
                </div>
              </div>
>>>>>>> efbe8361a2c79d93dd4805cd7a3f2a76f2bd367c
            ...
            <div class="details-content">
              ...
              <div class="bebida-list">
                <div v-for="(bebida, index) in bebidas" :key="index" class="bebida-section">
                  ...
                  <div v-if="bebida.selected" class="ingredients-section">
                    <v-btn
                      @click="viewIngredients(bebida, 'bebida')"
                      class="ingredients-button"
                      style="background-color: orange; color: white;"
                    >Ver Ingredientes</v-btn>
                  </div>
              ...
              <div class="button-container">
                <v-btn @click="addBebida" class="action-button bebidas-add-button">Añadir otra bebida</v-btn>
                <div class="button-space">
                  <v-btn @click="saveBebidas" class="action-button bebidas-save-button">Guardar</v-btn>
                  <v-btn @click="cancelBebidas" class="action-button bebidas-cancel-button">Cancelar</v-btn>
                  <button @click="showBebidasSection = false" class="close-button bebidas-close-button">CERRAR</button>
>>>>>>> efbe8361a2c79d93dd4805cd7a3f2a76f2bd367c
                </div>
            </div>
            ...
            <div class="details-content">
              ...
              <div class="postre-list">
                <div v-for="(postre, index) in postres" :key="index" class="postre-section">
                  ...
                  <div v-if="postre.selected" class="ingredients-section">
                    <v-btn
                      @click="viewIngredients(postre, 'postre')"
                      class="ingredients-button"
                      style="background-color: orange; color: white;"
                    >Ver Ingredientes</v-btn>
                  </div>
              ...
              <div class="button-container">
                <v-btn @click="addPostre" class="action-button postres-add-button">Añadir otro postre</v-btn>
                <div class="button-space">
                  <v-btn @click="savePostres" class="action-button postres-save-button">Guardar</v-btn>
                  <v-btn @click="cancelPostres" class="action-button postres-cancel-button">Cancelar</v-btn>
          ...
          <div v-if="showIngredients" class="details-overlay">
            <div class="details-content">
              ...
              <div class="ingredients-list">
                ...
                >
                  <v-checkbox v-model="ingredient.available" :label="ingredient.name" class="custom-checkbox"></v-checkbox>
                </div>
              </div>
              <div style="display: flex; justify-content: space-around;">
                <v-btn @click="saveIngredients" class="action-button ingredients-save-button">Guardar Ingredientes</v-btn>
                <v-btn @click="closeIngredients" class="action-button ingredients-close-button">Cerrar</v-btn>
>>>>>>> efbe8361a2c79d93dd4805cd7a3f2a76f2bd367c
              </div>
            </div>
          </div>
...
>>>>>>> efbe8361a2c79d93dd4805cd7a3f2a76f2bd367c
              ...
              <v-btn @click="sendOrder" class="send-order-button">Enviar Orden</v-btn>
            </div>
          </div>
          ...
          <div v-if="showHistorial" class="details-overlay">
            <div class="details-content">
              ...
              <v-btn @click="closeHistorial" class="action-button historial-close-button">Cerrar</v-btn>
            </div>
          </div>
              ...
              <div class="edit-order-sections">
                ...
                <div class="platillo-list">
                  ...
                  <div v-for="(platillo, index) in platillos" :key="index" class="platillo-section">
                    ...
                    <v-btn @click="removePlatillo(index)" class="action-button remove-button">Eliminar</v-btn>
                  </div>
                  <v-btn @click="addPlatillo" class="action-button platillos-add-button">Añadir otro platillo</v-btn>
                </div>
                ...
                <div class="bebida-list">
                  ...
                  <div v-for="(bebida, index) in bebidas" :key="index" class="bebida-section">
                    ...
                    <v-btn @click="removeBebida(index)" class="action-button remove-button">Eliminar</v-btn>
                  </div>
                  <v-btn @click="addBebida" class="action-button bebidas-add-button">Añadir otra bebida</v-btn>
                </div>
                ...
                <div class="postre-list">
                  ...
                  <div v-for="(postre, index) in postres" :key="index" class="postre-section">
                    ...
                    <v-btn @click="removePostre(index)" class="action-button remove-button">Eliminar</v-btn>
                  </div>
                  <v-btn @click="addPostre" class="action-button postres-add-button">Añadir otro postre</v-btn>
                </div>
              </div>
              <div class="button-container">
                <v-btn @click="saveEditedOrder" class="action-button save-edit-button">Guardar Cambios</v-btn>
                <v-btn @click="cancelEditOrder" class="action-button cancel-edit-button">Cancelar</v-btn>
              </div>
            </div>
          </div>
          ...
          <div v-if="showOrderDetails" class="details-overlay">
            <div class="details-content">
              ...
              <v-btn @click="closeOrderDetails" class="action-button order-details-close-button">Cerrar</v-btn>
            </div>
          </div>
        </div>
        </v-img>
...
const editOrder = (index) => {
  ...
  platillos.value = orderToEdit.orders
    .filter((order) => order.type === 'Platillo')
    .map((p) => ({
      ...p,
      ingredients: ingredientOptions[p.item] || [],
    }));
  bebidas.value = orderToEdit.orders
    .filter((order) => order.type === 'Bebida')
    .map((b) => ({
      ...b,
      ingredients: ingredientOptions[b.item] || [],
    }));
  postres.value = orderToEdit.orders
    .filter((order) => order.type === 'Postre')
    .map((p) => ({
      ...p,
      ingredients: ingredientOptions[p.item] || [],
    }));
...
const saveEditedOrder = () => {
  const updatedOrder = {
    ...
    orders: [...platillos.value, ...bebidas.value, ...postres.value],
